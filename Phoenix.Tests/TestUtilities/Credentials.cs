...
namespace Phoenix.Tests.TestUtilities
{
    public static class Credentials
    {
        ...
        public static string APT_RA_PASSWORD = "NwNiEPS6";
        ...
        public static string APT_RD_PASSWORD = "NwNiEPS6";
